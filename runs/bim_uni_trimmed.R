...
population_file <- "data/demographics_bm_trim.csv"
pkdata_file <- "data/dataset_bm_trim.csv"
...
ans <- NPOD(sim_file, pkdata_file, params, individuals, population_functions, c0=0.3, c1=0.7)
